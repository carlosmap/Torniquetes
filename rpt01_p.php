...
function valida()
{
	...
	{
		e="s";
		msg="Seleccione una división o ingrese una unidad.\n ";
	}
/*
    ...
    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
      <tr>
        ...
        <?	if( ( $ano != "" ) && ( $mess != "" ) && ( ( $division != "" )||($uni!="")) ){		?>
		        <a href="../canafisto/modulo Ficha predial/rpt02.php?anio=<?= $ano ?>&mes=<?= $mess ?>&division=<?= $division ?>&departamento=<?= $departamento ?>&uni=<?=$uni  ?>" class="FichaInAct1" >Grafica</a>
        <?	}		?>
        </td>
        <td>&nbsp;</td>
      </tr>
