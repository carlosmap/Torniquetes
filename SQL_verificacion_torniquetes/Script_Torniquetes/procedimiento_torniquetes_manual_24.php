...
//								$sql_consul_entradas=$sql_consul_entradas." and MONTH( tlob.Fecha)='01' and year(tlob.Fecha)='2013' and day(tlob.Fecha)='31' ";  //TEMPORAL
/*					
