...
<?php
	...
	{
		$sql_dep_div="
		select HojaDeTiempo.dbo.Departamentos.nombre as departamento, HojaDeTiempo.dbo.Divisiones.nombre as division from HojaDeTiempo.dbo.Usuarios 
...
//echo $departamento." **// ".$division."<br>".mssql_get_last_message()." <br>".$sql_dep_div;
	}
?>
...
//echo "aumenta salidas<br>";
					...
					if($ban==1)
					{
						...
						//si se presenta la situacion en que el id_registro de salida es inferior al de la entrada, y no hay mas registros de salida, entonces se muestra
						//los datos de la entrada, y se visualiza cnat entradas 1 y cant salidas 0, por eso se asigna el valor de -1 a $cant_salidas, para
						// restarlo cuando se incremente las salidas
						$cant_salidas_real=-1;
					}
					else
					{
...
-->
					...
					<td  width="10%" rowspan="2"><?php //echo $diferencia_horas." --";
														 echo round($diferencia_horas * 100)/100; ?></td>
