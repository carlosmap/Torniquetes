...
$conexion = conectar();
echo "ver 22222222222222222222222222222";
if($recarga==2)
{
echo "ingersoooo 2222222<br><br>";
	//consulta las personas que hacen parte de la division y el departamento

	$sql_consul_perso="  select distinct(t.unidad),NoTarjeta, u.nombre as Nombres,u.apellidos as Apellidos, d.nombre as Departamento from HojaDeTiempo.dbo.TMEntradas as t
