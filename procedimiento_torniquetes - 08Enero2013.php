...
$ff=0;
			...
			{
$ff++;
				$sql_insert="insert into HojaDeTiempo.dbo.TMEntradas (unidad,id_division,id_departamento,IdTerminal,Torniquete,NoTarjeta,NoDocumento,FechaCompleta,Fecha,Hora,EntradaSalida)values(";
				$sql_insert=$sql_insert."".$datos_entradas["unidad"].",".$datos_entradas["id_division"].",".$datos_entradas["id_departamento"].",".$datos_entradas["IdTerminal"].",'".$datos_entradas["Torniquete"]."',".$datos_entradas["NoTarjeta"].",".$datos_entradas["NoDocumento"].",'".$datos_entradas["FechaCompleta"]."','".$datos_entradas["Fecha"]."','".$datos_entradas["Horas"]."','".$datos_entradas["EntradaSalida"]."')";
...
//		$sql_consul_salidas=$sql_consul_salidas." and dv.id_division=14";
...
$ff=0;
			...
			{
$ff++;
				$sql_insert="insert into HojaDeTiempo.dbo.TMSalidas (unidad,id_division,id_departamento,IdTerminal,Torniquete,NoTarjeta,NoDocumento,FechaCompleta,Fecha,Hora,EntradaSalida)values(";
				$sql_insert=$sql_insert."".$datos_salidas["unidad"].",".$datos_salidas["id_division"].",".$datos_salidas["id_departamento"].",".$datos_salidas["IdTerminal"].",'".$datos_salidas["Torniquete"]."',".$datos_salidas["NoTarjeta"].",".$datos_salidas["NoDocumento"].",'".$datos_salidas["FechaCompleta"]."','".$datos_salidas["Fecha"]."','".$datos_salidas["Horas"]."','".$datos_salidas["EntradaSalida"]."')";
				$cur_insert=mssql_query($sql_insert);
